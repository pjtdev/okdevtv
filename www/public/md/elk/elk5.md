...
tar xvfz elasticsearch-5.2.1.tar.gz
ln -s elasticsearch-5.2.1 elasticsearch
cd elasticsearch
bin/elasticsearch -d
...
tar xvfz kibana-5.2.1-linux-x86_64.tar.gz
ln -s kibana-5.2.1-linux-x86_64 kibana
cd kibana
```
...
tar xvfz logstash-5.2.1.tar.gz
ln -s logstash-5.2.1 logstash
cd logstash
```
...
tar xvfz filebeat-5.2.1-linux-x86_64.tar.gz
ln -s filebeat-5.2.1-linux-x86_64 filebeat
cd filebeat
